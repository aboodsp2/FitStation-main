...
const List<String> kNationalities = [
  ...
  "Salvadoran","Saudi Arabian","Senegalese","Serbian","Sierra Leonean",
  ...
  Future<void> _submit() async {
    ...
    if (age < 16) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Text("You must be at least 16 years old to use FitStation."),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          _input(_ageCtrl, "Age (must be 16+)", Icons.calendar_today_outlined,
              TextInputType.number),
          const SizedBox(height: 14),
          _input(_weightCtrl, "Weight (kg)", Icons.monitor_weight_outlined,
              TextInputType.number),
          const SizedBox(height: 14),
          _input(_heightCtrl, "Height (cm)", Icons.height_rounded,
              TextInputType.number),
          const SizedBox(height: 14),
