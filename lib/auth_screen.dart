...
class AuthFlowHandler extends StatefulWidget {
  ...
  @override State<AuthFlowHandler> createState() => _AuthFlowHandlerState();
}
...
class _AuthFlowHandlerState extends State<AuthFlowHandler> {
  ...
  void _go(int page) => _pageCtrl.animateToPage(page,
...
class VerifyEmailPage extends StatefulWidget {
  ...
  const VerifyEmailPage(
      {super.key, required this.onBackToLogin, required this.fullName});
  ...
  Future<void> _verify() async {
    ...
    if (updated?.emailVerified ?? false) {
      await FirebaseFirestore.instance
          .collection('users').doc(updated!.uid).set({
    ...
    return Scaffold(
      ...
      body: SafeArea(child: Column(children: [
        Align(alignment: Alignment.centerLeft,
          child: Padding(padding: const EdgeInsets.only(left: 12, top: 8),
        ...
        Text("Verify Your Email",
            style: AppTheme.heading.copyWith(fontSize: 28, letterSpacing: 0.4)),
        const SizedBox(height: 14),
        Padding(padding: const EdgeInsets.symmetric(horizontal: 40),
          child: Text("We've sent a verification link to:",
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 36),
          child: Column(children: [
            _hint(Icons.inbox_rounded, "Check your inbox (and spam folder)"),
            const SizedBox(height: 8),
            _hint(Icons.touch_app_rounded, "Tap the link in the email"),
            const SizedBox(height: 8),
            _hint(Icons.check_circle_outline_rounded,
...
class _IntroPageState extends State<IntroPage> {
  ...
  void initState() {
    ...
    _vc = VideoPlayerController.asset('assets/intro.mp4')
      ..initialize().then((_) {
        _vc.setLooping(true); _vc.play(); _vc.setVolume(0);
        setState(() {});
      });
  }
    ...
    return _AuthBg(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          // email field
          _Input(icon: Icons.email_outlined, hint: "Email",
...
class SignUpPage extends StatefulWidget {
  ...
  const SignUpPage(
      {super.key, required this.onLoginTap, required this.onVerificationSent});
        ...
        SingleChildScrollView(child: Column(children: [
          ...
          const Text("SIGN UP",
              style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold,
                  color: Colors.white)),
          const SizedBox(height: 20),
          _Input(icon: Icons.person_outline, hint: "Full Name",
