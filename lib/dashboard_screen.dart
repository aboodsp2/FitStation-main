...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  @override
  void initState() { super.initState(); CartManager().addListener(_onCart); }
  @override
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Icon(icon, color: sel ? AppTheme.primary : AppTheme.muted,
              size: sel ? 26 : 24),
    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          ...
          const Spacer(),
          Text("See all", style: AppTheme.body.copyWith(
        ...
        return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Row(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppTheme.primary.withOpacity(0.15),
                ...
                child: photoUrl != null
                    ? Image.network(photoUrl, fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) =>
                            Icon(Icons.person_rounded, color: AppTheme.primary, size: 28))
                    : Icon(Icons.person_rounded, color: AppTheme.primary, size: 28),
              ),
            ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.logout_rounded, color: AppTheme.primary, size: 20),
            ),
          ),
        ]);
      },
  ...
  Widget _banner() => Column(children: [
    ...
    Row(mainAxisAlignment: MainAxisAlignment.center,
      children: List.generate(_banners.length, (i) => AnimatedContainer(
        ...
        width: _bannerIdx == i ? 22 : 6, height: 6,
        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(22),
              boxShadow: [BoxShadow(color: cols[0].withOpacity(0.4),
