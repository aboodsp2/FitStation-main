...
class _SupplementStoreScreenState extends State<SupplementStoreScreen> {
        ...
        builder: (ctx, snap) {
            ...
            return Scaffold(
              body: Center(child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text("Could not load supplements",
          ...
          return CustomScrollView(slivers: [
            ...
            SliverAppBar(
              ...
              actions: [
                IconButton(
                  icon: Icon(_query.isEmpty
                      ? Icons.search_rounded : Icons.close_rounded,
                      color: AppTheme.dark),
                  onPressed: () {
            ...
            // ── Category sections ────────────────────────────────────
              ...
              for (final cat in _categories)
                if (grouped.containsKey(cat))
                  SliverToBoxAdapter(
                    child: _section(cat, grouped[cat]!),
                  ),
  ...
  Widget _heroBanner() => Container(
    ...
    child: Row(children: [
      ...
      const Icon(Icons.shopping_bag_outlined, color: Colors.white30, size: 60),
    ]),
  );
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(
          ...
          children: List.generate(preview.length, (i) => Expanded(
            child: Padding(
              padding: EdgeInsets.only(right: i < preview.length - 1 ? 8 : 0),
            ...
            ? ClipRRect(borderRadius: BorderRadius.circular(10),
                child: Image.network(item.imageUrl, fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => Icon(
                        Icons.science_rounded, color: AppTheme.accent, size: 36)))
      ...
      Container(width: 52, height: 52,
        ...
        child: item.imageUrl.isNotEmpty
            ? ClipRRect(borderRadius: BorderRadius.circular(12),
                child: Image.network(item.imageUrl, fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => Icon(
                        Icons.science_rounded, color: AppTheme.accent, size: 28)))
      ...
      Container(
        ...
        child: item.imageUrl.isNotEmpty
            ? ClipRRect(
                ...
                child: Image.network(item.imageUrl, fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => Icon(
                        Icons.science_rounded, color: AppTheme.accent, size: 46)))
      ...
      appBar: AppBar(
        ...
        title: const Text("All Products",
            style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700,
                fontSize: 17, color: AppTheme.dark)),
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (_, snap) {
          ...
          if (items.isEmpty) return Center(
            child: Text("No supplements in the database.",
                style: AppTheme.body));
...
Widget _cartIcon(BuildContext context, int count) => Stack(children: [
  IconButton(
